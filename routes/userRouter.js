...
import { getApplicationStat, getCurrentUser, updateUser } from "../controllers/userController.js";
...
router.get('/admin/app-stats', authorizePermissions('admin'), getApplicationStat)
